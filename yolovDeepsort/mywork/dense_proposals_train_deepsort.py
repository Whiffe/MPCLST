...
parser.add_argument('--yoloLabel_dir', default='../yolov5/runs/detect/newExp',type=str, help="Label path for yolov5")
parser.add_argument('--avaMin_dense_proposals_dir', default='./avaMin_dense_proposals_train.pkl',type=str, help="avaMin_dense_proposals_dir")
parser.add_argument('--show', default='show',type=str, help="show")

arg = parser.parse_args()

#传参 labelPath是yolov5检测结果的位置，需要获取0（0代表人）的四个坐标值，还需要检测概率
labelPath = arg.yoloLabel_dir

#传参 保存为pkl的地址，这是像ava数据集对齐
# ./avaMin_dense_proposals_train.pkl
avaMin_dense_proposals_path = arg.avaMin_dense_proposals_dir
