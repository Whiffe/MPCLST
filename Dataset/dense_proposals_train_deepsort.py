...
parser.add_argument('--yoloLabel_dir', default='./Dataset01/detect/newExp',type=str, help="Label path for yolov5")
parser.add_argument('--dense_proposals_dir', default='./Dataset01/dense_proposals_train_deepsort.pkl',type=str, help="dense_proposals_dir")
...
dense_proposals_path = arg.dense_proposals_dir
